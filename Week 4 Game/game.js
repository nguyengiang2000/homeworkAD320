...
(function() {
  ...
  function advanceTimer() {
    ...
    let minutesUpdate = Math.floor(remainingSeconds / SECONDS_IN_MINUTE);
    let secondsUpdate = remainingSeconds % SECONDS_IN_MINUTE;
    
    let resultUpdate = String(minutesUpdate).padStart(2, "0") + ":" + String(secondsUpdate).padStart(2, "0");
    id("time").textContent = resultUpdate;
